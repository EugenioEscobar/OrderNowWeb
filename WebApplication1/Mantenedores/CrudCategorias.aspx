...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="form-row">
            <h1 class="align-content-lg-center">Administrar Categorias
            </h1>
        </div>
        <div class="form-row">
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:OrderNowBDConnectionString %>' SelectCommand="SELECT * FROM [ClasificacionAlimento]"></asp:SqlDataSource>
    </div>
</asp:Content>
