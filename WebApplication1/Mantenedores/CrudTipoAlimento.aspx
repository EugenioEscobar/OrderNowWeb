<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="CrudTipoAlimento.aspx.cs" Inherits="WebApplication1.Mantenedores.CrudTipoAlimento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h1 class="align-content-lg-center">Administrar Tipo de Alimento
        </h1>
    </div>
    <div>
    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="IdTipoAlimento" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand">
