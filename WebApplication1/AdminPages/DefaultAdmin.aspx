...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolderTitle" runat="server">
    Pedidos en Curso
</asp:Content>
                ...
                <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" CssClass="table" 
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-CssClass="align-middle">
                            <HeaderTemplate>
                                <asp:Label runat="server" ID="Lavel1" Text="Confirmación"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="align-middle" HeaderText="Número de Pedido">
                            <ItemTemplate>
                                <asp:Label ID="lblCodigo" runat="server" Text='<%# Bind("IdPedido") %>' Style="margin: auto"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField ItemStyle-CssClass="align-middle" HeaderText="Alimentos">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="Direccion" ItemStyle-CssClass="align-middle" HeaderText="Dirección" SortExpression="Direccion" />
                        <asp:BoundField DataField="Tipo_Pedido" ItemStyle-CssClass="align-middle" HeaderText="Tipo de Pedido" SortExpression="Tipo_Pedido" />
                    </Columns>
                    <EmptyDataTemplate>
