            ...
            try
            {
                switch (e.CommandName)
                {
                    case "Editar":
                        ...
                        Alimento obj = aDAL.Find(codigo);
                        txtNombre.Text = obj.Nombre;
                        txtCalorias.Text = obj.Calorías != null ? obj.Calorías.ToString() : "";
                        txtValor.Text = obj.Precio.ToString();
                        btnAgregar.Visible = false;
                        btnModificar.Visible = true;
                        IngredienteAlimento.EliminarIngredientes();
                        ViewState["IdAlimento"] = codigo;

                        List<IngredientesAlimento> lista = aDAL.BuscarIngredientesPorAlimento(codigo);
